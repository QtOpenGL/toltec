...
*   ADD UNIFORM
*-----------------------------------------------------------------------------*/
void UniformArray::addUniform(std::unique_ptr<Uniform> p_uniform, GLuint shaderProgramID)
{
...
*   FIND LOCATIONS
*-----------------------------------------------------------------------------*/
void UniformArray::findLocations(const std::string& baseUniformName, GLuint shaderProgramID)
{
...
*   ADD UNIFORM
*-----------------------------------------------------------------------------*/
void UniformStruct::addUniform(std::unique_ptr<Uniform> p_uniform, GLuint shaderProgramID)
{
...
*   FIND LOCATIONS
*-----------------------------------------------------------------------------*/
void UniformStruct::findLocations(const std::string& baseUniformName, GLuint shaderProgramID)
{
    //This function serves the purpose of finding locations for uniforms inside

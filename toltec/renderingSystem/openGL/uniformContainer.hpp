...
public:
    ...
    //ADD
    virtual void    addUniform(std::unique_ptr<Uniform> p_uniform, GLuint shaderProgramID) {}

    //GET
    UniformContainer::Type      getType() const;

    //OTHER
    virtual void    findLocations(const std::string& baseUniformName, GLuint shaderProgramID) {}
